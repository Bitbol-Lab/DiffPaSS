...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'diffpass.base': { 'diffpass.base.DiffPASSMixin': ('base.html#diffpassmixin', 'diffpass/base.py'),
            ...
            'diffpass.data_utils': { 'diffpass.data_utils.create_specieswise_dict': ( 'data_utils.html#create_specieswise_dict',
                                                                                      'diffpass/data_utils.py'),
                                     'diffpass.data_utils.dataset_tokenizer': ( 'data_utils.html#dataset_tokenizer',
                                                                                'diffpass/data_utils.py'),
                                     'diffpass.data_utils.generate_dataset': ('data_utils.html#generate_dataset', 'diffpass/data_utils.py'),
                                     'diffpass.data_utils.get_dataset_from_species': ( 'data_utils.html#get_dataset_from_species',
                                                                                       'diffpass/data_utils.py'),
            ...
            'diffpass.model': { 'diffpass.model.BestHits': ('model.html#besthits', 'diffpass/model.py'),
                                ...
                                'diffpass.model.BestHits.prepare_fixed': ('model.html#besthits.prepare_fixed', 'diffpass/model.py'),
            ...
            'diffpass.train': { 'diffpass.train.DiffPASSResults': ('train.html#diffpassresults', 'diffpass/train.py'),
                                ...
                                'diffpass.train.Information._hard_pass': ('train.html#information._hard_pass', 'diffpass/train.py'),
                                'diffpass.train.Information._prepare_fit': ('train.html#information._prepare_fit', 'diffpass/train.py'),
                                'diffpass.train.Information._record_current_log_alphas': ( 'train.html#information._record_current_log_alphas',
                                                                                           'diffpass/train.py'),
                                'diffpass.train.Information._soft_pass_and_backward': ( 'train.html#information._soft_pass_and_backward',
                                                                                        'diffpass/train.py'),
                                ...
                                'diffpass.train.InformationAndBestHits.__init__': ( 'train.html#informationandbesthits.__init__',
                                                                                    'diffpass/train.py'),
                                'diffpass.train.InformationAndBestHits._adjust_cfg_and_ensemble_shape': ( 'train.html#informationandbesthits._adjust_cfg_and_ensemble_shape',
                                                                                                          'diffpass/train.py'),
                                ...
                                'diffpass.train.InformationAndBestHits._precompute_bh': ( 'train.html#informationandbesthits._precompute_bh',
                                                                                          'diffpass/train.py'),
                                'diffpass.train.InformationAndBestHits._prepare_fit': ( 'train.html#informationandbesthits._prepare_fit',
                                                                                        'diffpass/train.py'),
                                'diffpass.train.InformationAndBestHits.effective_loss_weights_': ( 'train.html#informationandbesthits.effective_loss_weights_',
                                                                                                   'diffpass/train.py'),
                                'diffpass.train.InformationAndBestHits.fit': ('train.html#informationandbesthits.fit', 'diffpass/train.py'),
                                'diffpass.train.InformationAndBestHits.forward': ( 'train.html#informationandbesthits.forward',
                                                                                   'diffpass/train.py'),
                                'diffpass.train.InformationAndBestHits.hard_': ( 'train.html#informationandbesthits.hard_',
                                                                                 'diffpass/train.py'),
                                'diffpass.train.InformationAndBestHits.soft_': ( 'train.html#informationandbesthits.soft_',
                                                                                 'diffpass/train.py'),
