...
# %% auto 0
__all__ = ['generate_dataset', 'single_and_paired_seqs', 'msa_tokenizer', 'dataset_tokenizer']
...
def single_and_paired_seqs(
    ...
    *,
    ...
    for s in group_sizes:
        ...
        unique_xy, counts_xy = np.unique(np.array(xy_seqs), return_counts=True)
        xy_seqs.append(dict(zip(unique_xy, counts_xy)))
        idx += s

    return {"x_seqs": x_seqs, "y_seqs": y_seqs, "xy_seqs": xy_seqs}
